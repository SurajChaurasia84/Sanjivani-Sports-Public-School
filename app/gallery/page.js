      ...
      <Section className="bg-slate-50" title="Video Highlights" subtitle="Watch our students in action.">
        <div className="max-w-4xl mx-auto aspect-video rounded-[3rem] overflow-hidden shadow-2xl relative group bg-slate-900">
           ...
           <div className="absolute inset-0 flex items-center justify-center">
             <div className="w-24 h-24 bg-emerald-600 text-white rounded-full flex items-center justify-center shadow-2xl transition-transform duration-300 group-hover:scale-110 cursor-pointer">
                <div className="w-0 h-0 border-t-[15px] border-t-transparent border-l-[25px] border-l-white border-b-[15px] border-b-transparent ml-2"></div>
             </div>
           </div>
           <div className="absolute bottom-10 left-10 text-white">
              <h3 className="text-2xl font-bold font-display">Annual Sports Day 2025</h3>
              <p className="text-emerald-400 opacity-90">Coming Soon to our YouTube Channel</p>
           </div>
        </div>
      </Section>
    </div>
