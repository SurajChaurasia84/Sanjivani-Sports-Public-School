...
export default async function AcademicsPage() {
      ...
      <div className="flex flex-col md:flex-row gap-12 items-start">
        <div className="flex-1">
          <h3 className="text-2xl font-bold text-slate-900 mb-6 flex items-center gap-3">
            <BookOpen className="text-emerald-600" /> Subjects Offered
          </h3>
        ...
        <div className="md:w-1/3 bg-emerald-50 p-8 rounded-2xl">
          <Award className="text-emerald-600 mb-4" size={40} />
          <h4 className="text-lg font-bold text-emerald-900 mb-2">Academic Highlights</h4>
  ...
  return (
    <div className="bg-white">
      {/* Page Header */}
      <div className="bg-emerald-900 py-20 text-white text-center">
      ...
      <Section title="Overview" subtitle="Empowering students with a forward-thinking curriculum.">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-3xl p-10 md:p-16 shadow-2xl border border-emerald-50 relative overflow-hidden group hover:border-emerald-200 transition-all">
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="flex gap-4">
                  <div className="w-12 h-12 bg-emerald-600 text-white flex-shrink-0 rounded-full flex items-center justify-center font-bold text-xl">1</div>
                  <div>
                ...
                <div className="flex gap-4">
                  <div className="w-12 h-12 bg-emerald-600 text-white flex-shrink-0 rounded-full flex items-center justify-center font-bold text-xl">2</div>
                  <div>
      ...
      <Section title="Evaluation System" subtitle="Continuous and Comprehensive Evaluation for overall mapping.">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white p-10 rounded-3xl shadow-xl border border-slate-100 flex flex-col items-center text-center">
            ...
            <div className="mt-auto w-full pt-6 border-t border-slate-50 text-emerald-600 font-bold uppercase tracking-widest text-xs">Summer Session</div>
          </div>
          <div className="bg-white p-10 rounded-3xl shadow-xl border border-slate-100 flex flex-col items-center text-center">
        ...
        <div className="mt-12 text-center bg-emerald-900 text-white p-8 rounded-3xl flex flex-col md:flex-row items-center justify-center gap-8 shadow-2xl shadow-emerald-200">
          <p className="text-xl font-medium tracking-wide">
            Our system is built on <span className="text-emerald-400 font-bold underline decoration-2 underline-offset-4">Continuous and Comprehensive Evaluation</span>.
          </p>
